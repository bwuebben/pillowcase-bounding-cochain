...
comes from immersed-curve models, but the implementation itself does not prove
that it enumerates every relevant holomorphic polygon.
...
The synthetic unlink test checks that the region rejected by the bigon predicate
is accepted by this triangle predicate. It is an implementation test, not a full
A-infinity or bounding-cochain calculation.
"""
import math
